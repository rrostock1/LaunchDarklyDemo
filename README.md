...
Please place an .env file in the root directory containing the following line: `LAUNCHDARKLY_API_TOKEN=xxx-xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx`, replacing the placholder value with the API token (provided separately).
